...
const StatsCard = () => {
    return (
        <div className='py-8 flex justify-between flex-col md:flex-row gap-6'>
            <div className='flex gap-2 items-start bg-white border p-4 rounded-md w-full hover:-translate-y-1 transition-all duration-500'>
                <div className='rounded-full bg-gray-300 p-2 h-12 w-12 grid place-content-center'>
                    <i class='bx bxs-dollar-circle text-2xl text-[#425a8b]' ></i>
                </div>
                <div>
            ...
            <div className='flex gap-2 items-start bg-white border p-4 rounded-md w-full hover:-translate-y-1 transition-all duration-500'>
                <div className='rounded-full bg-green-200 p-2 h-12 w-12 grid place-content-center'>
                    <i class='bx bxs-truck text-2xl text-green-500' ></i>
                </div>
                <div>
            ...
            <div className='flex gap-2 items-start bg-white border p-4 rounded-md w-full hover:-translate-y-1 transition-all duration-500'>
                <div className='rounded-full bg-orange-200 p-2 h-12 w-12 grid place-content-center'>
                    <i class='bx bx-package text-2xl text-orange-500' ></i>
                </div>
                <div>
            ...
            <div className='flex gap-2 items-start bg-white border p-4 rounded-md w-full hover:-translate-y-1 transition-all duration-500'>
                <div className='rounded-full bg-emerald-200 p-2 h-12 w-12 grid place-content-center'>
                    <i class='bx bx-basket text-2xl text-sky-400' ></i>
                </div>
                <div>
